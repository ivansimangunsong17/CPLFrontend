...
const DetailMonitoringMahasiswaKaprodi = () => {
    ...
    const handleViewDetail = (mahasiswaId, matakuliahId) => {
        if (mahasiswaId && matakuliahId) {
            navigate(`/dashboard/kaprodi/detail_monitoring_mahasiswa/${mahasiswaId}/${matakuliahId}`);
        } else {
...
export default DetailMonitoringMahasiswaKaprodi;
