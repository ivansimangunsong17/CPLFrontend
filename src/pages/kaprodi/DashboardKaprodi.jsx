...
import TabelDistribusiKaprodi from "../../components/Chart/TabelDistribusiKaprodi";
...
const DashboardKaprodi = () => {
  ...
  const dummyMhs = [
    { npm: "2115061001", nama: "Budi Siregar", angkatan: 2021, prodi: "Teknik Informatika" },
    { npm: "2115061002", nama: "Siti Aulia Rahma", angkatan: 2021, prodi: "Teknik Informatika" },
    { npm: "2115061003", nama: "Dimas Pratama", angkatan: 2021, prodi: "Teknik Informatika" },
    { npm: "2115061004", nama: "Indah Permatasari", angkatan: 2021, prodi: "Teknik Informatika" },
    { npm: "2115061005", nama: "Ahmad Fadli", angkatan: 2021, prodi: "Teknik Informatika" },
    { npm: "2115061006", nama: "Dewi Anjani", angkatan: 2021, prodi: "Teknik Informatika" },
    { npm: "2115061007", nama: "Bagas Saputra", angkatan: 2021, prodi: "Teknik Informatika" },
    { npm: "2115061008", nama: "Ayu Lestari", angkatan: 2021, prodi: "Teknik Informatika" },
    { npm: "2115061009", nama: "Fahmi Ramadhan", angkatan: 2021, prodi: "Teknik Informatika" },
    { npm: "2115061010", nama: "Rama Wahyu Ajie Pratama", angkatan: 2021, prodi: "Teknik Informatika" },
  ];
      ...
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        <div className="bg-white rounded-2xl shadow-sm ">
          ...
          <div className="flex flex-wrap items-center justify-between mb-5 gap-3">
            <h1 className="text-2xl font-bold text-gray-900 p-4">Monitoring Penyelesaian Mata Kuliah Mahasiswa</h1>

            {/* Search */}
            <div className="relative w-full sm:w-[260px] px-2">
              <input
                type="text"
                placeholder="Cari Mahasiswa..."
                className="w-full bg-gray-50 border border-gray-200 rounded-xl px-4 py-2.5 pl-10 text-sm 
          ...
          <div className="overflow-x-auto rounded-xl border border-gray-100">
            <table className="min-w-full text-sm">
              <thead>
                <tr className="bg-blue-600 text-white font-semibold">
                  ...
                  <th className="p-3 text-center">Angkatan ↓</th>
              ...
              <tbody>
                {filteredMhs.map((mhs, i) => (
                  <tr key={i} className="border-b border-gray-100 hover:bg-gray-50 transition">
                    <td className="p-3 text-gray-700">{mhs.npm}</td>
                    <td className="p-3 font-medium text-gray-900">{mhs.nama}</td>
                    <td className="p-3 text-center text-gray-700">{mhs.angkatan}</td>
                    <td className="p-3 text-gray-700">{mhs.prodi}</td>
                    <td className="p-3 text-center">
                      <button
                        onClick={() => navigate(`detail_monitoring_mahasiswa/${mhs.npm}`)}
                        className="text-blue-600 font-medium hover:text-blue-800 transition flex items-center justify-center gap-1">
                        Lihat 👁
                      </button>
                    </td>
                  </tr>
            ...
            {filteredMhs.length === 0 && (
              <div className="text-center py-6 text-gray-400 text-sm">Tidak ada data mahasiswa</div>
            )}
          </div>
