...
const DetailDistribusiMatakuliah = () => {
    ...
    const handleViewDetail = (kelasId) => {
        ...
        navigate(`/dashboard/admin_prodi/detail_distribusi_matakuliah/${currentMataKuliahId}/${kelasId}`);
    };
...
export default DetailDistribusiMatakuliah;