...
const DetailDistribusiKelas = () => {
    ...
    const handleViewDetailMahasiswa = (mahasiswaId) => {
        ...
        navigate(`/dashboard/admin_prodi/detail_distribusi_matakuliah/${currentMKId}/${currentKelasId}/${mahasiswaId}`);
    };
...
export default DetailDistribusiKelas;